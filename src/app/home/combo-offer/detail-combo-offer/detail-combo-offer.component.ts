...
@Component({
  selector: 'app-detail-combo-offer',
  templateUrl: './detail-combo-offer.component.html',
  styleUrls: ['./detail-combo-offer.component.scss'],
})
export class DetailComboOfferComponent implements OnInit {
  comboOffer: any = {};
  referralCode: string = '';
  referralUser: any = {};
  ...
  ngOnInit() {
    ...
    this.eventService.getComboOfferSubs().subscribe((offer: any) => {
      this.comboOffer = offer;
      this.payTotal = this.comboOffer.totalPrice - this.comboOffer.discount;
      this.afterDiscountTotal = this.comboOffer.totalPrice - this.comboOffer.discount;
    });
